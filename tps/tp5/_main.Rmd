...
list.of.packages <- c("ggplot2", "dplyr", "lme4", "lmerTest", "car", "GGally")
...
shapiro.test(e)
```
     No tenemos evidencia para decir que los residuos no tienen provienen de una distribución normal. Es decir, tenemos homocedasticidad.
