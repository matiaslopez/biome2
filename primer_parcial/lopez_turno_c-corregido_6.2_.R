...
df <- read.table("/home/jose/Documents/materias/biome2/2021/primer parcial/GRUPO 4/datos.txt", header = T) # levanto los datos
...
SE ESTIMAN 8 MEDIAS Y 2 VARIANZAS.
...
FALTA MAGNITUD DEL EFECTO IC 95%.
+0.5
...
A DOSIS DE CROMO 0 Y PARA UNA CAJA TIPICA
...
El 96% de la variabilidad aleatoria de la biomasa está explicada por las variación entre cajas sometidas a la misma combinación de dosis de cromo e inóculo, o de manera equivalente, 0.96 es el grado de asociación/correlación entre observaciones de una misma caja.
+0.5
